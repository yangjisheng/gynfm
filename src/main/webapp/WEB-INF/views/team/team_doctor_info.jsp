...
<link rel="stylesheet" type="text/css"
	href="resources/css/doctor_info.css" />
<link rel="stylesheet" type="text/css"
		...
		<div class="inner">
			...
			<div class="mod mod2">
				<div class="col_news">
					<div class="r_dh">
						<div class="r_dh_bt">
							当前位置：医疗团队&nbsp;&gt;&nbsp; <span>医生</span>队&nbsp;&gt;&nbsp; <span>信息</span>
						</div>
					</div>
					...
					<div id="intro" class="content-list content-list-active"
						...
						<div class="one-three">
							<div class="photo-frame">
								<img src="resources/images/doctor/${doctor.img }" alt="Photo of me">
							</div>
						</div>
						<div class="two-three">
							<h2>${doctor.name }</h2>
