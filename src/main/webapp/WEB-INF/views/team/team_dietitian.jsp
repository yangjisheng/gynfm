		...
		<div class="inner">
			...
			<div class="mod mod2">
				...
				<div class="doctors container">
					<div class="line1">
						<c:forEach items="${dietitians }" var="dietitian">
							<div class='column' data-id="${dietitian.id }">
								<div class='post-module'>
									<!--缩略图-->
									<div class='thumbnail'>
										<img src='resources/images/doctor/${dietitian.img }'>
									</div>
									<div class='post-content'>
										<div class='category'>${dietitian.name }</div>
