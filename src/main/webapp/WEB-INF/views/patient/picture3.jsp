						...
						<div class="col_news_list" frag="窗口6" portletmode="simpleList">
							...
							<div class="wp_single wp_column_article" id="wp_column_article">
								<div class="wp_entry">
									...
									<!-- 图片展示 -->
									<div>
									<h1 align="center">破冰活动，认识你我</h1>
									<div id="photos" class="galleryview">
										  <div class="panel">
										     <img  src="resources/images/img3/破冰活动 (1).JPG" /> 
										    
										  </div>
										  
										  <div class="panel">
										     <img  src="resources/images/img3/破冰活动 (2).JPG" /> 
										   
										  </div>
										  
										  <div class="panel">
										     <img src="resources/images/img3/破冰活动 (3).JPG" /> 
										  ...
										  <ul class="filmstrip">
										    <li><img height="100px" width="100px" src="resources/images/img3/破冰活动 (1).JPG"/></li>
										    <li><img height="100px" width="100px" src="resources/images/img3/破冰活动 (2).JPG"/></li>
										    <li><img height="100px" width="100px" src="resources/images/img3/破冰活动 (3).JPG" /></li>
										    <li><img height="100px" width="100px" src="resources/images/img3/破冰活动 (4).JPG"/></li>
