...
<body>
	...
	<div class="wrapper" id="container">
		<div class="inner">
				...
				src="resources/images/toppicture4.jpg"></div>
				<div class="mod mod3" >
							<div class="navtitle4"></div>
		<!--左侧栏开始-->
		<script>
		$(document).ready(function() {
			...
			<div class="mainProNav">
				<dl class="navM1">
					<dt><a href="nurse_introduction.do"  target="_self">护理概况</a></dt>
				</dl>
				<dl class="navM2">
					<dt><a href="nurse_nurse.do"  target="_self">专科护士介绍</a></dt>
				</dl>
				<dl class="navM3">
					<dt><a href="nurse_angel.do"  target="_self">天使文苑</a></dt>
				</dl>			
