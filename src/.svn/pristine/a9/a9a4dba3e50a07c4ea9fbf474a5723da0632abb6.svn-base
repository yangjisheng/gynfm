						...
						<div class="col_news_list" frag="窗口6" portletmode="simpleList">
							...
							<div class="wp_single wp_column_article" id="wp_column_article">
								<div class="wp_entry">
									...
									<!-- 图片展示 -->
									<div>
									<h1 align="center">健康筛查，你我同行</h1>
									<div id="photos" class="galleryview">
										  <div class="panel">
										     <img  src="resources/images/img2/健康筛查 (1).JPG" /> 
										    
										  </div>
										  
										  <div class="panel">
										     <img src="resources/images/img2/健康筛查 (2).JPG" /> 
										   
										  </div>
										  
										  <div class="panel">
										     <img src="resources/images/img2/健康筛查 (3).JPG" /> 
										    
										  </div>
										  
										  <div class="panel">
										     <img src="resources/images/img2/健康筛查 (4).JPG" /> 
										    
										  </div>
										  
										  
										  <ul class="filmstrip">
										    <li><img height="100px" width="100px" src="resources/images/img2/健康筛查 (4).JPG" /></li>
										    <li><img height="100px" width="100px" src="resources/images/img2/健康筛查 (4).JPG" /></li>
										    <li><img height="100px" width="100px" src="resources/images/img2/健康筛查 (4).JPG" /></li>
										    <li><img height="100px" width="100px" src="resources/images/img2/健康筛查 (4).JPG" /></li>
